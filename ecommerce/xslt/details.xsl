  ...
  <div class="column">
    <div class="content">
                ...
                <xsl:attribute name="href">
                    order.php?id=<xsl:value-of select="@id"/> &amp; price=<xsl:value-of select="priceperunit"/>
                </xsl:attribute>
                        ...
                        <div class="card-body" >
                         <h5 class="card-title"><xsl:value-of select="name"/></h5>
                           <h6 class="card-title"><xsl:value-of select="description" /></h6>
                            <h6 class="card-title">Price:<xsl:value-of select="priceperunit" /></h6>
                             <h6 class="card-title">Units left:<xsl:value-of select="units" /></h6>
