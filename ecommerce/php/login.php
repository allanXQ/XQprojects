...
<body>
   ...
   <form class="contact-form row" action='login.php' method="post">
      ...
      <div class="form-field col-lg-12">
         <input class="submit-btn" type="submit" value="Submit" name='submit'>
         <a href="/freelance/ecommerce/php/register.php" style="margin-left:10%">Register</a>
      </div>
   </form>
</section>
	<script type="text/javascript">
           ...
           if(isset($_POST['submit'])){
            ...
            strpos($xml, "<password>$password</password>") == true) {
              ...
              header('location:/freelance/ecommerce/php/dashboard.php');
            }
            else{
             echo 'invalid user';
            die();
